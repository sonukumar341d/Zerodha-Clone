        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                ...
                <div className='col'>
                    ...
                    <br />
                    <a href="" className="text-muted" style={{ textDecoration: "none" }}>Priceing</a>
                    <br />
                    ...
                    <br />
                    <a href="" className="text-muted" style={{ textDecoration: "none" }}>Predd&Media</a>
                    <br />
                ...
                <div className='col'>
                    ...
                    <br />
                    <a href="" className="text-muted" style={{ textDecoration: "none" }}>60 days challenge</a> 
                    <br />
                </div>
            </div>
